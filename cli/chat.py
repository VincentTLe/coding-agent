...
# ---------------------------------------------------------------------------
#
# PROBLEM: context window của model có hạn (Qwen3-14B: 32K, đọc từ
# models.json). Mỗi turn append assistant + tool messages — qua 20-30 turns,
# history dễ vượt limit → vLLM trả 400 "context length exceeded" và REPL
# crash. Claude Code giải quyết bằng auto-summarize: khi history quá dài,
# gom các turn cũ thành 1 summary và giữ recent turns nguyên xi.
#
# THRESHOLDS:
#   COMPACT_THRESHOLD_TOKENS = 75% của cfg.context_window (chừa headroom)
