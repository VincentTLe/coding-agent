...
- skillopt (SkillOpt paper + repo: validation gate, edit ops, protected slow-update region — the faithful core we ported): https://arxiv.org/abs/2605.23904 + https://github.com/microsoft/SkillOpt (MIT), downloaded 2026-05-27 → `skillopt/*`
